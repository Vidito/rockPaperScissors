# I have not included the images. You need to use your own images with PNG extension
...
layout = [ [sg.Push(), sg.Text('Choose an option'), sg.Push()],
           [sg.Button(image_source='rock.png', key='rockUser'), sg.Button(image_source='paper.png', key='paperUser'),
            sg.Button(image_source='scissors.png', key='scissorsUser')],
            [sg.Push(), sg.Image('man.png'), sg.Text('VS'), sg.Image('computer.png'), sg.Push()],
